...
//seelct state from store
const storeData = useSelector(store=>store?.users)
const {loading,appErr, serverErr,registered,isRegistered} = storeData
console.log(isRegistered,1)
//redirect
if (isRegistered) {
  return navigate("/login") ;
}
console.log(isRegistered,2)


  return (
    <section className="relative py-10 2xl:py-40 bg-gray-800 overflow-hidden">
              ...
              <form onSubmit={formik.handleSubmit} >
                  ...
                  <div className="flex items-center pl-6 mb-3 bg-white rounded-full">
                    ...
                    onBlur={formik.handleBlur("firstName")}
                      className="w-full pl-4 pr-6 py-3 font-bold placeholder-gray-300 rounded-r-full focus:outline-none"
                      type="firstName"
                  ...
                  <button
                    disabled
                    className="py-3 w-full bg-gray-500  text-white font-bold rounded-full transition duration-200"
                  >
                    loading please wait...
                  </button>):(<button
                    type="submit"
                    className="py-3 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200"
                  >
                    Register
                  </button>)}
                </form>
